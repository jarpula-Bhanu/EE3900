...
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/1.1.py
\end{lstlisting}
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/1.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.2.py
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/1.3.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.3.py
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/1.4.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.4.py
...
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/Codes/2.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 2.2.py
...
\end{figure}
\item 		Find $X^{+}(z)$.\\
\solution from eqn\eqref{eq:one-Z} 
\begin{align}
	x(n) = x(n+2) - x(n+1)
\end{align}
...
\end{align}
	\item Find $x(n)$.\\
	\solution Expanding $X^+(z)$ in \eqref{eq:ztransform_x} using partial fractions, we get
\begin{align}
...
\begin{lstlisting}
    wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/2.4.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 2.4.py
...
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/Codes/2.5.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 2.5.py
...
\solution Using \eqref{eq:ztransform_x},
\begin{align}
...
Download and run the following code.
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/2.7.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 2.7.py
...
\begin{lstlisting}
wget https://github.com/jarpula-Bhanu/EE3900/blob/main/Pingala/codes/3.6.py
\end{lstlisting}
